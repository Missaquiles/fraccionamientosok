...
<div class="col-md-8">
    <div class="row justify-content-center mx-auto">
        <div class="card text-white bg-dark border-light mb-2" style="width: 24rem;">
            ...
            <div class="card-body">
                <form action="/usuario/update/{{$usuario->idUsuario}}" method="post" enctype="multipart/form-data">
                @csrf
                    <div class="input-group form-group justify-content-center">
                        <img class = "img-responsive w-75" src="img-pic/{{$usuario->fotografia}}" alt="{{$usuario->fotografia}}" class="rounded-circle">
                    </div>
                    <div class="input-group form-group justify-content-center">
